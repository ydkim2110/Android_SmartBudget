...
public class HomeTAGroupListHeaderAdapter extends RecyclerView.Adapter<HomeTAGroupListHeaderAdapter.MyViewHolder> {

    private static final String TAG = HomeTAGroupListHeaderAdapter.class.getSimpleName();
    ...
    public HomeTAGroupListHeaderAdapter(Context mContext, HashMap<String, List<TransactionItem>> hashMap) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        for (TransactionItem model : value) {
            Log.d(TAG, "onBindViewHolder: subCategoryId: "+model.getSubCategoryId());
        ...
        HomeTAGroupListAdapter adapter = new HomeTAGroupListAdapter(mContext, value);
