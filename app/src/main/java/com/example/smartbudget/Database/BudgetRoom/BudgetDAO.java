...
public interface BudgetDAO {
    ...
    @Query("SELECT id, description, amount, start_date AS startDate, end_date AS endDate, type, account_id AS accountId, "
    ...
    long insertBudget(BudgetItem budgetItem);

    @Delete
    int deleteBudget(BudgetItem budgetItem);
